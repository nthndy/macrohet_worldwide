...
<p>The textbook view is that Mtb grows slowly, doubling roughly once a day, and that this slowness helps it survive drug treatment. But when these researchers built a microscope system to watch thousands of individual infected cells over days, they found something surprising — and then tested whether it mattered for how well antibiotics work.</p>`,
            ...
            3: `<p>TB — tuberculosis — has been around for thousands of years and still kills over a million people every year. The treatment is hard going: you need to take a mix of antibiotics for <em>months</em>. Nobody fully understands why it takes so long.</p>
<p>The bacterium that causes it — Mtb, for short — has a clever trick. It hides inside the very immune cells that are supposed to kill it. A bit like a burglar hiding in a police station. Once inside, it starts multiplying. Scientists always thought it grew slowly — roughly one division per day — and that this slowness was part of why drugs struggle to clear it.</p>
<p>But nobody had actually watched individual bacteria growing inside individual human cells in real time with enough detail to be sure. So that's what this team did — they built a system to film the whole process. What they found challenges the standard explanation for why TB is so hard to treat.</p>`,
...
<p>After carefully filtering out these false growth events using mathematical modelling and manual checks, they ended up with 590 clear examples of genuine intracellular bacterial doubling to analyse in detail.</p>`,
            ...
            3: `<p>The team set up something like a time-lapse camera, pointed at thousands of immune cells, each one potentially carrying TB bacteria, and let it run for three days. The immune cells glow green, the bacteria glow pink, so you can watch the bacteria multiplying inside each cell over time.</p>
<p>They tracked over 18,000 individual cells this way. Some were packed with bacteria, others had barely any. They also had to be careful about telling the difference between real bacterial growth and cases where a cell suddenly picked up extra bacteria from outside, or inherited them from a dead neighbour — those look similar in the data but mean very different things.</p>
<p>After filtering all of that out, they were left with about 590 clear cases of a bacterium genuinely doubling inside a specific cell, which they could then study in detail.</p>`,
...
<p>In other words: the antibiotics preferentially killed the slow and normal growers, leaving the fast growers behind. This is the opposite of what the traditional model predicts — you'd expect slow/dormant bacteria to survive treatment, not the fast ones.</p>`,
            ...
            3: `<p>When they measured how fast the bacteria were multiplying inside each cell, the results were all over the place — some doubled in under 10 hours, others took more than 70. There was enormous variation from cell to cell.</p>
<p>Then they added antibiotics. At normal doses, the distribution didn't change much. But when they used very high doses — enough to stop almost all the bacteria — something striking happened. The small number of bacteria that survived were overwhelmingly the <em>fast</em> growers.</p>
<p>With the strongest dose of rifampicin (one of the main TB drugs), the proportion of fast growers among survivors went from 14% to 64%. The antibiotics were wiping out the slow bacteria and leaving the fast ones behind. That's the opposite of what most people expected.</p>`,
...
<p>Inside macrophages, they found that cells carrying more bacteria tended to have faster-growing populations. And when antibiotics were added, the bacteria that survived treatment were still actively growing — their "speedometer" stayed in the green. This independently confirmed that it's the growing bacteria, not the dormant ones, that evade drug treatment.</p>`,
            ...
            3: `<p>To double-check, they engineered the bacteria with a sort of built-in indicator. When the bacteria are growing fast, they glow green. When they slow down, they shift to red. It works like a speedometer for bacteria.</p>
<p>Sure enough, the cells with the most bacteria had the greenest — meaning fastest-growing — bugs. Even after antibiotics, the survivors were still glowing green, still actively dividing. So it wasn't a quirk of the first experiment. The fast growers genuinely do survive treatment.</p>`,
...
<p>This confirmed their cell-culture results in a real infection: fast-growing TB bacteria survive antibiotic treatment in living animals.</p>`,
            ...
            3: `<p>That's all well and good in a dish, but does it happen in a real infection? To find out, they infected mice with the colour-changing TB bacteria, let proper infections develop, and then gave them antibiotics for three weeks — the same drugs used on human patients.</p>
<p>The drugs did reduce the overall numbers, as you'd hope. But when they looked closely at individual cells in the lungs, the bacteria that survived were still growing fast. The mice that responded worst to treatment had the fastest-growing survivors.</p>
<p>So it's not just something that happens in the lab. In a real infection, in a living animal, the fast growers are the ones that get through.</p>`,
...
<p>Why might fast growth help bacteria survive drugs? Several possibilities: they might be dividing faster than drugs can kill them, they might not accumulate enough drug inside, or they might be better at pumping drugs back out. Whatever the mechanism, these findings mean TB researchers and drug developers need to think about fast-growing bacteria as an additional target alongside dormant ones.</p>`,
            ...
            3: `<p>So what does this all mean? For decades, the assumption was that TB bacteria survive treatment by going dormant — if you're not growing, drugs can't get you. And that's partly true. But this study shows that some bacteria take the <em>opposite</em> approach: they grow so fast they essentially outpace the drugs. It's the difference between hiding from a predator and simply being faster than it.</p>
<p>Each of the three main TB drugs showed this to different degrees. Rifampicin was the most striking — at the highest dose, nearly two-thirds of the survivors were fast growers. In mice, the animals that failed to clear their infection were the ones with the fastest-dividing bacteria.</p>
<p>The upshot is that if we want to cure TB more effectively, we can't only focus on the dormant bacteria. We also need to work out how to deal with the fast-growing ones.</p>`,
